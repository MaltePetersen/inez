...
let SavedListRoutingModule = class SavedListRoutingModule {
};
...
let SavedListComponent = class SavedListComponent {
    ...
    getEinkaufslist() {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/api/zettel/item/malte.petersen@frs.de").subscribe((data) => console.log(data));
    }
    onEnter(value) {
        ...
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/api/word/' + value).subscribe((name) => {
            console.log(amount);
            if (this.purchaseListDTO.purchaseItemDTOList.filter((data) => data.produktDTO.id === name.id).length !== 0) {
                ...
                this.purchaseListDTO.purchaseItemDTOList.push(new _domain_namespace__WEBPACK_IMPORTED_MODULE_4__["PurchaseItemDTOList"](name, amount));
            }
            this.table.renderRows();
        });
    }
    load(formData) {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/api/zettel/items/' + formData.email).subscribe((data) => {
            console.log(data);
    ...
    loadSpecificList(purchaseListDTO) {
        this.purchaseListDTO = purchaseListDTO;
        this.table.renderRows();
    }
};
SavedListComponent.ctorParameters = () => [
...
let SavedListModule = class SavedListModule {
};
...
//# sourceMappingURL=savedLists-saved-list-module-es2015.js.map