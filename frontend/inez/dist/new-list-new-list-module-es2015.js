...
let NewListRoutingModule = class NewListRoutingModule {
};
...
let NewListComponent = class NewListComponent {
        ...
        if (value || value !== "") {
            ...
            this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/api/word/' + value).subscribe((name) => {
                if (this.purchaseListDTO.purchaseItemDTOList.filter((data) => data.produktDTO.id === name.id).length !== 0) {
                    ...
                    this.purchaseListDTO
                        .purchaseItemDTOList.push(new _domain_namespace__WEBPACK_IMPORTED_MODULE_4__["PurchaseItemDTOList"](name, amount));
                }
                window.localStorage.setItem('currentList', JSON.stringify(this.purchaseListDTO));
    ...
    save(formData) {
        ...
        this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/api/zettel/list', this.purchaseListDTO).subscribe((data) => console.log(data));
    }
};
...
let NewListModule = class NewListModule {
};
...
//# sourceMappingURL=new-list-new-list-module-es2015.js.map